...
// Add angular modules and jQuery
    ...
    wp_enqueue_script( 'angular-ui-mask', plugin_dir_url( __FILE__ ) . 'src/app/modules/angular-ui-mask/mask.min.js' );

    wp_enqueue_script( 'lodash-4.16.6', 'https://unpkg.com/lodash@4.16.6' );
...
// Add angular 1.1.10
    ...
    wp_enqueue_style( 'angular-material-1.1.10-style', plugin_dir_url( __FILE__ ) . 'src/app/modules/angular-material/1.1.10/angular-material.min.css' );
...
// Add app styles
    ...
    wp_enqueue_style( 'unisyn-policy-generator', plugin_dir_url( __FILE__ ) . '/src/app/css/app.css' );
